    ...
    <div class="panel-body">
        <div class="col-sm-2">
            <div class="container">
                <img src="https://scontent-lax3-1.xx.fbcdn.net/v/t1.0-9/1936510_10207216981375364_4596889339024157957_n.jpg?oh=f3031e9add8769ca489e5865a54b6bc4&oe=57B0E02E"
                     class="img-rounded" alt="{{$client->first_name}} {{$client->middle_name}} {{$client->last_name}}"
                     height="150">
            </div>
        ...
        <div class="col-sm-10">
            <div class="container">
                ...
                <i class="fa fa-phone"></i> {{$client->number}} | <i class="fa fa-envelope"></i> {{$client->email}} </br>
                <address>
                    {{ $client->street }}&nbsp;,
                    {{ $client->suburb }}&nbsp;
                    {{ $client->state }}&nbsp;
