                  ...
                  <tbody>
                    ...
                    @if(($application->status_id) == 5)         
                      <tr>
                        ...
                        <td>{{ $application->company }}</td>
                          <td>
                            <a href="#" title="Prepare Invoice"><i class=" btn btn-primary btn-sm glyphicon glyphicon-education" data-toggle="tooltip" data-placement="top" title="Prepare Invoice"></i></a>
