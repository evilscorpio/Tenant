  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        @endif
        <h1>Application - <small>COE Processing</small></h1>
                  ...
                  <tbody>
                    ...
                    @if(($application->status_id) == 4)       
                      <tr>
                        ...
                        <td>{{ $application->company }}</td>
                          <td>
                            <a href="{{ route('applications.action.coe.issued',[$application->course_application_id])}}" title="COE Issued"><i class=" btn btn-primary btn-sm glyphicon glyphicon-education" data-toggle="tooltip" data-placement="top" title="COE Issued"></i></a>
