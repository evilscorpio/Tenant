                  ...
                  <tbody>
                    ...
                    @if(($application->status_id) == 4)       
                      <tr>
                        ...
                        <td>{{ $application->company }}</td>
                          <td>
                            <a href="{{ route('application.action.coe.issued',[$application->course_application_id])}}" title="COE Issued"><i class=" btn btn-primary btn-sm glyphicon glyphicon-education" data-toggle="tooltip" data-placement="top" title="COE Issued"></i></a>
